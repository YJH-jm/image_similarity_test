...
if __name__ == "__main__":
    ...
    full_dataset = data.TrainDataset(config.IMG_PATH, transforms_train)
    ...
    swin =model.from_pretrained('efficientnet-b0', num_classes=config.NUM_CLASSES) # 모델 + 학습된 weight
